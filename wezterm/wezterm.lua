...
config.background_shaders = { wezterm.config_dir .. "/.config/wezterm/shaders/text-glow.wgsl" }
config.custom_shaders = { wezterm.config_dir .. "/.config/wezterm/shaders/cursor-trail.wgsl" }
config.window_frame = {
